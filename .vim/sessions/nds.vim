...
silent only
cd /mnt/c/Projects/odoo11/nds
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 multicompany_payment/tests/test_multicompany_payment.py
badd +0 multicompany_payment/models/multicompany_payment.py
argglobal
silent! argdel *
$argadd ./
set stal=2
edit multicompany_payment/models/multicompany_payment.py
...
232
normal! zo
let s:l = 232 - ((0 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
232
normal! 05|
tabedit multicompany_payment/tests/test_multicompany_payment.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
7
normal! zo
let s:l = 44 - ((23 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
