...
omap \g :YcmCompleter GoToDefinitionElseDeclaration
xmap \g :YcmCompleter GoToDefinitionElseDeclaration
nmap \g :YcmCompleter GoToDefinitionElseDeclaration
...
nnoremap <SNR>121_: :=v:count ? v:count : ''
...
silent only
cd /mnt/c/Projects/odoo12/trustcode
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 zenlog_integration/models/product_product.py
badd +1 /mnt/c/Projects/odoo12/trustcode
badd +1 zenlog_integration/models/sale_order.py
badd +1 zenlog_integration/models/account_invoice.py
argglobal
silent! argdel *
$argadd /mnt/c/Projects/odoo12/trustcode
set stal=2
edit zenlog_integration/models/product_product.py
...
23
normal! 050|
tabedit zenlog_integration/models/sale_order.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
86
normal! 0
tabedit zenlog_integration/models/account_invoice.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
